...
stocks = ['BTC', 'ETH-USD', 'USDT-USD','USDC-USD','BNB-USD','XRP-USD','ADA-USD','DOGE-USD','SOL-USD','DOT-USD'
    ,'HEX-USD','MATIC-USD','DAI-USD','WBTC-USD','ETC-USD','STETH-USD','LEO-USD','LTC-USD','TRX-USD'
                                                                                                            ]
...
col5.metric("Beta 95% Conf Interval",
            "{:.4f} - {:.4f}".format(results.conf_int().iloc[0, 0], results.conf_int().iloc[0, 1]))
